...
function normalize(raw) {
  ...
  if(raw.completeTicket!==true || !legs.length || !Number.isInteger(raw.visibleLegCount) || raw.visibleLegCount!==legs.length) {
    draft.odds=null;uncertainFields.push('odds');
